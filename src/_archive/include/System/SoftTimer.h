 ...
 */
static inline uint32_t SoftTimer_Elapsed(sSoftTimer* pTimer) {
 ...
 *
 * @param pTimer A pointer to the soft timer object.
 * @return uint32_t The total elapsed time of the timer, in milliseconds.
 */
static inline uint32_t SoftTimer_Stop(sSoftTimer* pTimer) {
