 ...
 *
 *  Version constants for informational purposes and version-specific macro
 * creation. This header file contains the current LUFA version number in
 * several forms, for use in the user-application (for example, for printing out
...
/**@{*/
/** Constant for \ref LUFA_VERSION_RELEASE_TYPE indicating a development
 * release. */
...
/** Constant for \ref LUFA_VERSION_RELEASE_TYPE indicating a full official
 * release. */
#define LUFA_VERSION_RELEASE_TYPE_FULL 2
/**@}*/

/** Indicates the version number of the library, as an integer. \note This value
 * is only updates in non-development releases. */
