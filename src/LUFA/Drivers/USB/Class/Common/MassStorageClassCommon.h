...
/** \file
 *  \brief Common definitions and declarations for the library USB Mass Storage
 * Class driver.
 *
 *  Common definitions and declarations for the library USB Mass Storage Class
 * driver.
 *
 ...
 * Host modes for the USB Mass Storage Class.
 *
 *  @{
 */
...
/* Macros: */
/** Magic signature for a Command Block Wrapper used in the Mass Storage
 * Bulk-Only transport protocol. */
#define MS_CBW_SIGNATURE 0x43425355UL

/** Magic signature for a Command Status Wrapper used in the Mass Storage
 * Bulk-Only transport protocol. */
#define MS_CSW_SIGNATURE 0x53425355UL

/** Mask for a Command Block Wrapper's flags attribute to specify a command with
...
/** SCSI Sense Code to indicate that the unit requires attention from the host
 * to indicate a reset event, medium removal or other condition.
 */
#define SCSI_SENSE_KEY_UNIT_ATTENTION 0x06

/** SCSI Sense Code to indicate that a write attempt on a protected block has
 * been made. */
#define SCSI_SENSE_KEY_DATA_PROTECT 0x07

/** SCSI Sense Code to indicate an error while trying to write to a write-once
 * medium. */
...
/** SCSI Sense Code to indicate that an EXTENDED COPY command has aborted due to
 * an error. */
...
/** SCSI Sense Code to indicate an attempt to write past the end of a partition
 * has been made. */
#define SCSI_SENSE_KEY_VOLUME_OVERFLOW 0x0D

/** SCSI Sense Code to indicate that the source data did not match the data read
 * from the medium. */
...
/**@{*/
/** SCSI Additional Sense Code to indicate no additional sense information is
 * available. */
#define SCSI_ASENSE_NO_ADDITIONAL_INFORMATION 0x00

/** SCSI Additional Sense Code to indicate that the logical unit (LUN) addressed
 * is not ready. */
#define SCSI_ASENSE_LOGICAL_UNIT_NOT_READY 0x04

/** SCSI Additional Sense Code to indicate an invalid field was encountered
 * while processing the issued command. */
#define SCSI_ASENSE_INVALID_FIELD_IN_CDB 0x24

/** SCSI Additional Sense Code to indicate that a medium that was previously
 * indicated as not ready has now become ready for use.
 */
#define SCSI_ASENSE_NOT_READY_TO_READY_CHANGE 0x28

/** SCSI Additional Sense Code to indicate that an attempt to write to a
 * protected area was made. */
#define SCSI_ASENSE_WRITE_PROTECTED 0x27

/** SCSI Additional Sense Code to indicate an error whilst formatting the device
 * medium. */
...
/** SCSI Additional Sense Code to indicate a write to a block out outside of the
 * medium's range was issued. */
#define SCSI_ASENSE_LOGICAL_BLOCK_ADDRESS_OUT_OF_RANGE 0x21

/** SCSI Additional Sense Code to indicate that no removable medium is inserted
 * into the device. */
...
/**@{*/
/** SCSI Additional Sense Qualifier Code to indicate no additional sense
 * qualifier information is available. */
#define SCSI_ASENSEQ_NO_QUALIFIER 0x00

/** SCSI Additional Sense Qualifier Code to indicate that a medium format
 * command failed to complete. */
#define SCSI_ASENSEQ_FORMAT_COMMAND_FAILED 0x01

/** SCSI Additional Sense Qualifier Code to indicate that an initializing
 * command must be issued before the issued command can be executed.
 */
#define SCSI_ASENSEQ_INITIALIZING_COMMAND_REQUIRED 0x02

/** SCSI Additional Sense Qualifier Code to indicate that an operation is
 ...
 * interface descriptors relating to the Mass Storage device class.
 */
...
/** Enum for the Mass Storage class specific control requests that can be issued
 * by the USB bus host. */
 ...
 *
 *  Type define for a Command Block Wrapper, used in the Mass Storage Bulk-Only
 * Transport protocol.
 *
 ...
 *
 *  Type define for a Command Status Wrapper, used in the Mass Storage Bulk-Only
 * Transport protocol.
 *
 *  \note Regardless of CPU architecture, these values should be stored as
 * little endian.
 ...
 *
 *  Type define for a SCSI Sense structure. Structures of this type are filled
 * out by the device via the \ref MS_Host_RequestSense() function, indicating
 * the current sense data of the device (giving explicit error codes for the
 * last issued command). For details of the structure contents, refer to the
 * SCSI specifications.
 */
typedef struct
{
 ...
 *
 *  Type define for a SCSI Inquiry structure. Structures of this type are filled
 * out by the device via the \ref MS_Host_GetInquiryData() function, retrieving
 * the attached device's information.
 *
