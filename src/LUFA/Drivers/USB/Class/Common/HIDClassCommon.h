...
#define HID_DESCRIPTOR_JOYSTICK(MinAxisVal, MaxAxisVal, MinPhysicalVal, MaxPhysicalVal, Buttons)                                           \
	HID_RI_USAGE_PAGE(8, 0x01), HID_RI_USAGE(8, 0x04), HID_RI_COLLECTION(8, 0x01), HID_RI_USAGE(8, 0x01), HID_RI_COLLECTION(8, 0x00),      \
		HID_RI_USAGE(8, 0x30), HID_RI_USAGE(8, 0x31), HID_RI_USAGE(8, 0x32), HID_RI_LOGICAL_MINIMUM(16, MinAxisVal),                       \
		HID_RI_LOGICAL_MAXIMUM(16, MaxAxisVal), HID_RI_PHYSICAL_MINIMUM(16, MinPhysicalVal), HID_RI_PHYSICAL_MAXIMUM(16, MaxPhysicalVal),  \
		HID_RI_REPORT_COUNT(8, 3), HID_RI_REPORT_SIZE(8, (((MinAxisVal >= -128) && (MaxAxisVal <= 127)) ? 8 : 16)),                        \
		HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE), HID_RI_END_COLLECTION(0), HID_RI_USAGE_PAGE(8, 0x09),         \
		HID_RI_USAGE_MINIMUM(8, 0x01), HID_RI_USAGE_MAXIMUM(8, Buttons), HID_RI_LOGICAL_MINIMUM(8, 0x00), HID_RI_LOGICAL_MAXIMUM(8, 0x01), \
		HID_RI_REPORT_SIZE(8, 0x01), HID_RI_REPORT_COUNT(8, Buttons), HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE), \
		HID_RI_REPORT_SIZE(8, (Buttons % 8) ? (8 - (Buttons % 8)) : 0), HID_RI_REPORT_COUNT(8, 0x01), HID_RI_INPUT(8, HID_IOF_CONSTANT),   \
...
#define HID_DESCRIPTOR_KEYBOARD(MaxKeys)                                                                                                   \
	HID_RI_USAGE_PAGE(8, 0x01), HID_RI_USAGE(8, 0x06), HID_RI_COLLECTION(8, 0x01), HID_RI_USAGE_PAGE(8, 0x07),                             \
		HID_RI_USAGE_MINIMUM(8, 0xE0), HID_RI_USAGE_MAXIMUM(8, 0xE7), HID_RI_LOGICAL_MINIMUM(8, 0x00), HID_RI_LOGICAL_MAXIMUM(8, 0x01),    \
		HID_RI_REPORT_SIZE(8, 0x01), HID_RI_REPORT_COUNT(8, 0x08), HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),    \
		HID_RI_REPORT_COUNT(8, 0x01), HID_RI_REPORT_SIZE(8, 0x08), HID_RI_INPUT(8, HID_IOF_CONSTANT), HID_RI_USAGE_PAGE(8, 0x08),          \
		HID_RI_USAGE_MINIMUM(8, 0x01), HID_RI_USAGE_MAXIMUM(8, 0x05), HID_RI_REPORT_COUNT(8, 0x05), HID_RI_REPORT_SIZE(8, 0x01),           \
		HID_RI_OUTPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE | HID_IOF_NON_VOLATILE), HID_RI_REPORT_COUNT(8, 0x01),         \
		HID_RI_REPORT_SIZE(8, 0x03), HID_RI_OUTPUT(8, HID_IOF_CONSTANT), HID_RI_LOGICAL_MINIMUM(8, 0x00),                                  \
		HID_RI_LOGICAL_MAXIMUM(16, 0xFF), HID_RI_USAGE_PAGE(8, 0x07), HID_RI_USAGE_MINIMUM(8, 0x00), HID_RI_USAGE_MAXIMUM(8, 0xFF),        \
		HID_RI_REPORT_COUNT(8, MaxKeys), HID_RI_REPORT_SIZE(8, 0x08), HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_ARRAY | HID_IOF_ABSOLUTE),    \
		HID_RI_END_COLLECTION(0)
...
#define HID_DESCRIPTOR_MOUSE(MinAxisVal, MaxAxisVal, MinPhysicalVal, MaxPhysicalVal, Buttons, AbsoluteCoords)                              \
	HID_RI_USAGE_PAGE(8, 0x01), HID_RI_USAGE(8, 0x02), HID_RI_COLLECTION(8, 0x01), HID_RI_USAGE(8, 0x01), HID_RI_COLLECTION(8, 0x00),      \
		HID_RI_USAGE_PAGE(8, 0x09), HID_RI_USAGE_MINIMUM(8, 0x01), HID_RI_USAGE_MAXIMUM(8, Buttons), HID_RI_LOGICAL_MINIMUM(8, 0x00),      \
		HID_RI_LOGICAL_MAXIMUM(8, 0x01), HID_RI_REPORT_COUNT(8, Buttons), HID_RI_REPORT_SIZE(8, 0x01),                                     \
		HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE), HID_RI_REPORT_COUNT(8, 0x01),                                 \
		HID_RI_REPORT_SIZE(8, (Buttons % 8) ? (8 - (Buttons % 8)) : 0), HID_RI_INPUT(8, HID_IOF_CONSTANT), HID_RI_USAGE_PAGE(8, 0x01),     \
		HID_RI_USAGE(8, 0x30), HID_RI_USAGE(8, 0x31), HID_RI_LOGICAL_MINIMUM(16, MinAxisVal), HID_RI_LOGICAL_MAXIMUM(16, MaxAxisVal),      \
		HID_RI_PHYSICAL_MINIMUM(16, MinPhysicalVal), HID_RI_PHYSICAL_MAXIMUM(16, MaxPhysicalVal), HID_RI_REPORT_COUNT(8, 0x02),            \
...
#define HID_DESCRIPTOR_VENDOR(VendorPageNum, CollectionUsage, DataINUsage, DataOUTUsage, NumBytes)                                         \
	HID_RI_USAGE_PAGE(16, (0xFF00 | VendorPageNum)), HID_RI_USAGE(8, CollectionUsage), HID_RI_COLLECTION(8, 0x01),                         \
		HID_RI_USAGE(8, DataINUsage), HID_RI_LOGICAL_MINIMUM(8, 0x00), HID_RI_LOGICAL_MAXIMUM(8, 0xFF), HID_RI_REPORT_SIZE(8, 0x08),       \
		HID_RI_REPORT_COUNT(8, NumBytes), HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),                             \
		HID_RI_USAGE(8, DataOUTUsage), HID_RI_LOGICAL_MINIMUM(8, 0x00), HID_RI_LOGICAL_MAXIMUM(8, 0xFF), HID_RI_REPORT_SIZE(8, 0x08),      \
		HID_RI_REPORT_COUNT(8, NumBytes), HID_RI_OUTPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE | HID_IOF_NON_VOLATILE),     \
		HID_RI_END_COLLECTION(0)
/**@}*/
