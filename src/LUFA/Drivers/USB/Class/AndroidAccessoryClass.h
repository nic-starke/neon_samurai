...
/** \file
 *  \brief Master include file for the library USB Android Open Accessory Class
 * driver.
 *
 *  Master include file for the library USB Android Open Accessory Class driver,
 * for both host and device modes, where available.
 *
 ...
 *  \brief USB class driver for the Google Android Open Accessory class
 * standard.
 *
 ...
 *  Android Open Accessory Class Driver module. This module contains an internal
 * implementation of the USB Android Open Accessory Class, for Host USB mode.
 * User applications can use this class driver instead of implementing the
 * Android Open Accessory Class manually via the low-level LUFA APIs.
 *
 *  This module is designed to simplify the user code by exposing only the
 * required interface needed to interface with Host using the USB Android Open
 * Accessory Class.
 *
 *  @{
 */
