...
| `vmap-pill.js` | Small vertical A/B pill beside the encoder body, showing which vmap layer is currently active (highlighted). Real hardware always has 2 vmaps/encoder, but renders however many `count` says. | `count`, `active`, `powered` |
