---
id: bootloader-recovery
title: Bootloader recovery
summary: What to do when the device has no working bootloader and no software route back in.
order: 11
---
...
[Technical reference](12-technical.md#bootloader) for how NEON_SAMURAI enters the
bootloader.
...
### Verifying the bootloader over DFU {: #verify-bootloader }
...
## Provenance of the bootloader file {: #bootloader-provenance }

See [firmware/README.md](https://github.com/nic-starke/neon_samurai/blob/main/firmware/README.md) for where
